...
class HttpHelper {
  ...
  dynamic _returnResponse(http.Response response) {
    var parseResult = json.decode(response.body);
    var message = parseResult['error'] ?? parseResult['message'];
    switch (response.statusCode) {
      ...
      case 201:
        ...
        return result;
      case 401:
        throw UnauthorizedException(errorBody: message);
      case 500:
        throw ErrorRequestException(errorBody: message, errorCode: 500);
      default:
